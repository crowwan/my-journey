...
### 추가 개선 (이번 세션)
- [x] 3.5 TripBar 모바일 텍스트 표시 (hidden → truncate) [2026-03-15]
- [x] 3.6 MonthTripList 하단 여행 카드 리스트 추가 [2026-03-15]
- [x] 3.7 셀 높이 동적 확장 (바 개수 기반, 3개 제한 제거) [2026-03-15]
- [x] 3.8 같은 Trip 전체 바 동시 hover (hoveredTripId 상태) [2026-03-15]
- [x] 3.9 SummaryTab 캘린더 추가(ics) 버튼 제거 [2026-03-15]

---

## 완료 후

- [x] CLAUDE.md 업데이트 [2026-03-15]
- [x] 메모리 업데이트 [2026-03-15]
