    ...
    <div className="animate-fade-up">
      ...
      <div className="bg-card border border-border rounded-[14px] p-5 mb-3">
        <div className="flex flex-wrap items-center gap-2">
          {transport.homeToHotel.map((step, idx) => (
            <div key={idx} className="flex items-center gap-2">
              ...
              {idx < transport.homeToHotel.length - 1 && (
      ...
      <div className="bg-card border border-border rounded-[14px] overflow-hidden mb-3">
        <table className="w-full text-sm">
          ...
          <tbody>
            {transport.intercityRoutes.map((route, idx) => (
              <tr
                key={idx}
        ...
        <>
          ...
          <div className="bg-card border border-border rounded-[14px] p-5 mb-3">
            <ul className="space-y-2">
              {transport.icocaGuide.map((guide, idx) => (
