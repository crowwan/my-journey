...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-t border-border shadow-none pb-[env(safe-area-inset-bottom)]" style={{ minHeight: 'var(--bottom-nav-h)' }}>
